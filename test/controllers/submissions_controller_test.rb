...
class SubmissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create submission" do
    assert_difference("Submission.count") do
      post submissions_url, params: { submission: { task_id: @submission.task_id, user_id: @submission.user_id, version: @submission.version } }
    end
  ...
  test "should update submission" do
    patch submission_url(@submission), params: { submission: { task_id: @submission.task_id, user_id: @submission.user_id, version: @submission.version } }
